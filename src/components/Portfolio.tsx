          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-6 mb-10 md:mb-16">
            {achievements.map((achievement, index) => (
              <motion.div
                ...
                className="text-center p-4 md:p-6 bg-dark-lighter rounded-xl border border-primary/20 hover:border-primary/40 transition-all"
              >
                <div className="text-2xl md:text-4xl font-bold text-primary mb-2">{achievement.value}</div>
