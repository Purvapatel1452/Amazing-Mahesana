...
const episodes = [
  {
    number: '01',
    title: 'Digital Marketing in Small Cities',
    guest: 'Rahul Joshi',
  ...
  {
    number: '03',
    title: 'The Future of Local Business',
    guest: 'Amit Shah',
...
const guests = [
  { name: 'Rahul Joshi',  role: 'Marketing Expert',     initials: 'RJ', gradient: 'from-primary to-red-600'      },
  { name: 'Priya Mehta',  role: 'Entrepreneur',          initials: 'PM', gradient: 'from-orange-600 to-primary'  },
  { name: 'Amit Shah',    role: 'Business Consultant',   initials: 'AS', gradient: 'from-red-600 to-orange-500'  },
  { name: 'Kavya Patel',  role: 'Restaurant Owner',      initials: 'KP', gradient: 'from-primary to-secondary'   },
  { name: 'Ravi Desai',   role: 'Digital Creator',       initials: 'RD', gradient: 'from-orange-700 to-primary'  },
  { name: 'Neha Sharma',  role: 'Brand Strategist',      initials: 'NS', gradient: 'from-red-500 to-orange-600'  },
];

const podcastServices = [
  { title: 'Studio Recording',          desc: 'Acoustic treatment, condenser mics & real-time monitoring.',             icon: <MicrophoneIcon  className="w-5 h-5 text-primary" /> },
  { title: 'Audio Editing & Mastering', desc: 'Noise removal, music beds, chapter markers & broadcast mastering.',      icon: <MusicalNoteIcon className="w-5 h-5 text-primary" /> },
  { title: 'Video Production',          desc: 'Multi-camera setup with full post-production for YouTube & Reels.',      icon: <VideoCameraIcon className="w-5 h-5 text-primary" /> },
  { title: 'Distribution',              desc: 'Publish on Spotify, Apple Podcasts, JioSaavn & YouTube.',                icon: <ShareIcon       className="w-5 h-5 text-primary" /> },
];
    ...
    <div className="container">
      ...
      >
        ...
        <div className="text-center mb-14">
          ...
          <h2 className="heading-lg text-white mb-4">One Session. Infinite Reach.</h2>
          <p className="text-white/60 text-lg max-w-2xl mx-auto">
            Mahesana's first professional podcast studio — record, produce, and launch your voice to the world.
          </p>
        </div>
          ...
          <div className="relative flex flex-col lg:flex-row items-center justify-between gap-8">
            <div className="flex-1">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <a href="https://wa.me/+919227144346" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 btn bg-white/5 text-white border border-white/15 hover:bg-white/10 hover:border-primary/40 transition-all duration-300">
                  WhatsApp Us
                </a>
              </div>
            </div>
