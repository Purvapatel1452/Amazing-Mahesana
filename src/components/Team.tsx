...
const teamMembers: TeamMemberData[] = [
  {
    ...
    bio: '3+ years building the digital identity of Mahesana. The vision, strategy, and creative energy behind every campaign.',
    initials: 'NP',
  ...
  },
  {
    ...
    bio: 'Platform algorithm expert with a track record of scaling brand accounts from zero to 10K followers in under 90 days.',
    initials: 'PS',
  ...
  {
    name: 'Raj Mehta',
    role: 'Video Editor & Reel Creator',
    bio: 'Master of hooks, cinematic cuts, and transitions. Transforms raw footage into viral reels day after day.',
    initials: 'RM',
  ...
  },
  {
    ...
    bio: 'Brand identity specialist crafting thumb-stopping visuals, design systems, and scroll-worthy content every week.',
    initials: 'AP',
...
const TeamCard: React.FC<{ member: TeamMemberData; index: number }> = ({ member, index }) => (
  ...
  >
    {/* Top orange stripe that grows on hover */}
        ...
        >
          ...
          <div className="text-center mb-14">
            ...
            <p className="text-white/60 text-lg max-w-2xl mx-auto">
              The creative minds and strategic thinkers behind every campaign, reel, and viral moment.
            </p>
          </div>
