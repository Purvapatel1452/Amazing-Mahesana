...
const brandsRow2: BrandData[] = [
  ...
  { name: 'Vivo x200fe',           category: 'Mobile',           initials: 'VX', gradient: 'from-primary to-red-600',    logo: '/logos/Vivo.jpeg'                },
  { name: 'Vivo v60',              category: 'Mobile',           initials: 'V6', gradient: 'from-orange-600 to-primary', logo: '/logos/Vivo.jpeg'                },
  { name: 'Vivo x300 Pro',         category: 'Mobile',           initials: 'VP', gradient: 'from-red-600 to-orange-500', logo: '/logos/Vivo.jpeg'                },
  ...
  { name: 'Safari',                category: 'Fashion',          initials: 'SA', gradient: 'from-orange-600 to-primary', logo: '/logos/Safari.png'               },
  { name: 'Trendy Fashion',        category: 'Fashion',          initials: 'TF', gradient: 'from-red-600 to-orange-500', logo: '/logos/TrendyFashion.png'        },
  { name: 'Phonewale',             category: 'Mobile',           initials: 'PW', gradient: 'from-primary to-secondary',  logo: '/logos/Phonewale.jpeg'           },
  { name: 'HP Mobile',             category: 'Mobile',           initials: 'HP', gradient: 'from-orange-700 to-primary', logo: '/logos/HPMobile.jpeg'            },
  { name: 'Shivalik',              category: 'Real Estate',      initials: 'SV', gradient: 'from-red-500 to-orange-600', logo: '/logos/Shivalik.jpg'             },
  { name: 'Martinoz',              category: 'Fashion',          initials: 'MZ', gradient: 'from-primary to-red-600',    logo: '/logos/Martinoz.png'             },
  { name: 'Samarth Group',         category: 'Business',         initials: 'SR', gradient: 'from-orange-600 to-primary', logo: '/logos/SamarthGroup.jpeg'        },
  { name: 'RJ International',      category: 'Business',         initials: 'RI', gradient: 'from-red-600 to-orange-500', logo: '/logos/RJInternational.jpeg'     },
  { name: 'NamoiHub / DKOverseas', category: 'Business',         initials: 'NK', gradient: 'from-primary to-secondary',  logo: '/logos/NamoiHub.jpeg'            },
  { name: 'Sahaj',                 category: 'Business',         initials: 'SJ', gradient: 'from-orange-700 to-primary', logo: '/logos/Sahaj.png'                },
  { name: 'Alinor',                category: 'Business',         initials: 'AL', gradient: 'from-red-500 to-orange-600', logo: '/logos/Alinor.jpeg'              },
  { name: 'C85 Realms',            category: 'Real Estate',      initials: 'CR', gradient: 'from-primary to-red-600'                                             },
  { name: 'Mehta Agency',          category: 'Agency',           initials: 'ME', gradient: 'from-orange-600 to-primary', logo: '/logos/MehtaAgency.jpeg'         },
  { name: 'MMC',                   category: 'Business',         initials: 'MC', gradient: 'from-red-600 to-orange-500', logo: '/logos/MMC.jpeg'                 },
  { name: 'Achievers',             category: 'Education',        initials: 'AC', gradient: 'from-primary to-secondary',  logo: '/logos/Achievers.jpeg'           },
];
