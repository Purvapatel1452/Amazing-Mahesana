...
const socials = [
  { label: 'Instagram', icon: <InstagramIcon />, href: 'https://www.instagram.com/amazingmahesana', hoverClass: 'hover:bg-pink-500/20 hover:border-pink-500/40 hover:text-pink-400' },
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-14">
            ...
            <div className="sm:col-span-2 lg:col-span-1">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 rounded-xl overflow-hidden border border-primary/30 flex-shrink-0">
                  <img src="/amazingMehsana.jpg" alt="Amazing Mahesana" className="w-full h-full object-cover" />
                </div>
                <div>
                  <p className="text-white font-bold text-base leading-none">Amazing Mahesana</p>
                  <p className="text-primary text-xs mt-0.5">by Nikhil Patel</p>
                </div>
              </div>

              <p className="text-white/45 text-sm leading-relaxed mb-6">
                Mahesana's premium digital media &amp; social media management agency. We don't just post — we build brands.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li>
                  <a href="mailto:amazingmahesana02@gmail.com" className="flex items-start gap-3 group">
          ...
          <div className="border-t border-white/5 pt-8 pb-6">
            <div className="flex flex-wrap gap-x-6 gap-y-2 justify-center">
              {[
                'From Scratch to Viral – That\'s Stallion Style.',
                'Amazing Mahesana – For the Bold, For the Brands.',
                'Content That Converts, Reports That Matter.',
                'Why Just Exist? When You Can Dominate!',
              ].map((t) => (
          ...
          <div className="border-t border-white/5 pt-6 flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <p className="text-white/35 text-sm">
              Designed &amp; Built in <span className="text-primary font-medium">Mahesana</span>
            </p>
            {/* Back to top */}
            <button
              onClick={scrollToTop}
