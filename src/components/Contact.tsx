...
const channels = [
  ...
  {
    label: 'Instagram',
    value: '@amazingmahesana',
    href: 'https://www.instagram.com/amazingmahesana',
    icon: <InstagramIcon />,
    color: 'text-pink-400',
    bg: 'bg-pink-500/10',
  ...
  {
    label: 'Email',
    value: 'amazingmahesana02@gmail.com',
    href: 'mailto:amazingmahesana02@gmail.com',
  ...
  {
    label: 'Location',
    value: 'SF-215, Silicon Sponta, Radhanpur Road, Mehsana',
    href: 'https://maps.google.com/?q=SF-215+Silicon+Sponta+Radhanpur+Road+Mehsana+Gujarat+384002',
            ...
            >
              ...
              >
                <iframe
                  ...
                  src="https://maps.google.com/maps?q=SF-215+Silicon+Sponta+Radhanpur+Road+Mehsana+Gujarat+384002&output=embed&z=17"
                  width="100%"
                  height="100%"
